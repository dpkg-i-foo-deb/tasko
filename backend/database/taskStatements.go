...
func InitTaskStatements() {
	...
	GetTaskStatement, err = Database.Prepare(`SELECT title, description, code, main_task, user_email, start_date, due_date, status
	...
	GetAllTasksStatement, err = Database.Prepare(`SELECT title, description, code, main_task, user_email, start_date, due_date, status
